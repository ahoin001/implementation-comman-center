...
export const seedProjects: Project[] = [
  {
    ...
    notes: [
      { id: 'n1', content: 'Kickoff completed. Client excited about SmartWay integration.', createdAt: '2026-07-09T14:00:00Z', severity: 'info' },
      { id: 'n2', content: 'Melissa sent branding assets.', createdAt: '2026-07-08T10:30:00Z', severity: 'info' },
      { id: 'n3', content: 'Created staging site.', createdAt: '2026-07-06T09:00:00Z', pinned: true, severity: 'info' },
    ],
  ...
  },
  {
    ...
    notes: [{ id: 'n4', content: 'Waiting on client to confirm training date.', createdAt: '2026-07-08T12:00:00Z', severity: 'warning' }],
  ...
  },
  {
    ...
    notes: [{ id: 'n5', content: 'Homepage mockup in review.', createdAt: '2026-07-09T08:00:00Z', severity: 'info' }],
  ...
  },
  {
    ...
    notes: [{ id: 'n6', content: 'Final QA passed. Ready for launch.', createdAt: '2026-07-10T10:00:00Z', pinned: true, severity: 'info' }],
    createdAt: '2026-04-01T00:00:00Z',
  ...
  },
  {
    ...
    notes: [{ id: 'n7', content: 'Design blocked — waiting on logo files from client.', createdAt: '2026-07-08T15:00:00Z', severity: 'urgent' }],
